      ...
      <div className={styles.container}>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.contactInfo}>
            <div className={styles.contactItem}>
              ...
              <span>1415 FM 2216, Honey Grove, TX 75446</span>
            </div>
            <div className={styles.contactItem}>
              <svg
                className={styles.icon}
        ...
        <div className={styles.section}>
          ...
          <nav className={styles.links} aria-label="Footer navigation">
            <ul className={styles.linksList}>
              ...
              <li>
                <a href="/request-a-quote" className={styles.navLink}>
                  Request Quote
                </a>
              </li>
              <li>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.social}>
            <a
              href="https://www.facebook.com/qspallets"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/company/qspallets"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
            ...
            <a
              href="https://www.instagram.com/qspallets"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
